...
function getCustomerData(timestamp,lastRecordId){
	...
	//	columns[13] = new nlobjSearchColumn('custentity_se_sales_channel');
		...
		columns[26] = new nlobjSearchColumn('custentity323')
		columns[27] = new nlobjSearchColumn('custentity_sales_agent')
		columns[28] = new nlobjSearchColumn('custentity214')
		columns[29] = new nlobjSearchColumn('custentity245');
		columns[30] = new nlobjSearchColumn('homephone');
		columns[31] = new nlobjSearchColumn('custentity_dsg_service_panel_upgrade');
	    ...
	    if(searchresults) 
	    {
			...
			//		result.custentity_se_sales_channel = searchresult.getText('custentity_se_sales_channel');
				...
				//	result.site_id = searchresult.getValue('custentity_dsg_lead_site_id');
				    result.custentity323 = searchresult.getValue('custentity323');
					result.custentity_sales_agent = searchresult.getText('custentity_sales_agent');
					result.custentity214 = searchresult.getText('custentity214');
					result.custentity245 = searchresult.getValue('custentity245');
					result.homephone = searchresult.getValue('homephone');
					result.custentity_dsg_service_panel_upgrade = searchresult.getValue('custentity_dsg_service_panel_upgrade');
					results.push(result);
				}
				catch (e)
				{
...
function getSiteData(timestamp,lastRecordId){
	...
	filters[0] = new nlobjSearchFilter('lastmodified', 'null', 'onOrAfter', timestamp);
		...
		columns[54] = new nlobjSearchColumn('custrecord_dsg_site_homeowner');
		columns[55] = new nlobjSearchColumn('custrecord_dsg_cpm_list');
		columns[56] = new nlobjSearchColumn('custrecord_dsg_site_visit_status')
		columns[57] = new nlobjSearchColumn('custrecord_se_site_visit_sch_date')
		columns[58] = new nlobjSearchColumn('custrecord_dsg_site_visit_date')
		columns[59] = new nlobjSearchColumn('custrecord_dsg_site_vst_date_chng_reason')
		columns[60] = new nlobjSearchColumn('custrecord_se_permit_submit_date')
		columns[61] = new nlobjSearchColumn('custrecord_dsg_target_permit_date')
		columns[62] = new nlobjSearchColumn('custrecord_dsg_target_install_comm_date')
		columns[63] = new nlobjSearchColumn('custrecord_dsg_act_install_comm_date'); 
		columns[64] = new nlobjSearchColumn('custrecord_ahj_inspection_status');
		columns[65] = new nlobjSearchColumn('custrecord_dsg_ahj_inspect_approval_date')
        columns[66] = new nlobjSearchColumn('custrecord_dsg_inst2_pmt_status');
		columns[67] = new nlobjSearchColumn('custrecord_dsg_m2_pmt_status');
		columns[68] = new nlobjSearchColumn('custrecord_dsg_m3_stat3');
		columns[69] = new nlobjSearchColumn('custrecord_dsg_m3_dt3')
		columns[70] = new nlobjSearchColumn('custrecord_dsg_m3_stat4')
		columns[71] = new nlobjSearchColumn('custrecord_dsg_inst3_pmt_status')
		columns[72] = new nlobjSearchColumn('custrecord_dsg_m3_pmt_status')
		columns[73] = new nlobjSearchColumn('custrecord_dsg_lien_doc_status')
		columns[74] = new nlobjSearchColumn('custrecord_dsg_se2_pay_appr_date')
		columns[75] = new nlobjSearchColumn('custrecord_se_install_status')
		columns[76] = new nlobjSearchColumn('custrecord_dsg_target_install_date'); 
		columns[77] = new nlobjSearchColumn('custrecord_dsg_act_install_comm_date');
		...
		if(searchresults)
		{
			...
			{			
				...
				{ 
                    ...
                    result.custrecord_dsg_site_homeownerName = searchresult.getText('custrecord_dsg_site_homeowner');					
					...
					result.custrecord_dsg_site_homeowner = searchresult.getText('custrecord_dsg_site_homeowner');
					result.custrecord_dsg_cpm_list = searchresult.getText('custrecord_dsg_cpm_list');
					result.custrecord_dsg_site_visit_status = searchresult.getText('custrecord_dsg_site_visit_status');
					result.custrecord_se_site_visit_sch_date = searchresult.getValue('custrecord_se_site_visit_sch_date');
					result.custrecord_dsg_site_vst_date_chng_reason = searchresult.getText('custrecord_dsg_site_vst_date_chng_reason');
					result.custrecord_se_permit_submit_date = searchresult.getValue('custrecord_se_permit_submit_date');
					result.custrecord_dsg_site_visit_date = searchresult.getValue('custrecord_dsg_site_visit_date');
					result.custrecord_dsg_target_install_comm_date = searchresult.getValue('custrecord_dsg_target_install_comm_date');
					result.custrecord_dsg_target_permit_date = searchresult.getValue('custrecord_dsg_target_permit_date');
					result.custrecord_dsg_act_install_comm_date = searchresult.getValue('custrecord_dsg_act_install_comm_date');
					result.custrecord_ahj_inspection_status = searchresult.getText('custrecord_ahj_inspection_status');
					result.custrecord_dsg_ahj_inspect_approval_date = searchresult.getValue('custrecord_dsg_ahj_inspect_approval_date');
					result.custrecord_dsg_inst2_pmt_status = searchresult.getText('custrecord_dsg_inst2_pmt_status');
					result.custrecord_dsg_m2_pmt_status = searchresult.getText('custrecord_dsg_m2_pmt_status');
					result.custrecord_dsg_m3_stat3 = searchresult.getText('custrecord_dsg_m3_stat3');
					result.custrecord_dsg_m3_dt3 = searchresult.getValue('custrecord_dsg_m3_dt3');
					result.custrecord_dsg_m3_stat4 = searchresult.getText('custrecord_dsg_m3_stat4');
					result.custrecord_dsg_inst3_pmt_status = searchresult.getText('custrecord_dsg_inst3_pmt_status');
					result.custrecord_dsg_m3_pmt_status = searchresult.getText('custrecord_dsg_m3_pmt_status');
					result.custrecord_dsg_lien_doc_status = searchresult.getText('custrecord_dsg_lien_doc_status');
					result.custrecord_dsg_se2_pay_appr_date = searchresult.getValue('custrecord_dsg_se2_pay_appr_date');
					result.custrecord_se_install_status = searchresult.getText('custrecord_se_install_status');
					result.custrecord_dsg_target_install_date = searchresult.getValue('custrecord_dsg_target_install_date');
					result.custrecord_dsg_act_install_comm_date = searchresult.getValue('custrecord_dsg_act_install_comm_date');
